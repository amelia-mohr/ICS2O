...
var btnAddBag4 = document.getElementById('add-bag-4');
btnAddBag4.addEventListener('click', () => {
    let c = getCookie("cart");
    if (c == null) {
        // nothing in the cookie, just add our item
        document.cookie = "cart=" + JSON.stringify({Product4: num.innerHTML}) + "; path=/";
    } else {
